...
class Settings(BaseAgentConfig):
    ...
    classifier_v6_model_id: str | None = Field(default=None, description="Fine-tuned OpenAI model ID for classifier v6")
    classifier_v7_model_id: str | None = Field(default=None, description="Fine-tuned Gemma3 model ID for classifier v7")
