...
from agents.triage.classifiers.v8.classifier_v8 import (
...
class TestClassifierV8(unittest.TestCase):
    ...
    @patch('agents.triage.classifiers.v8.classifier_v8.RobertaForSequenceClassification')
    @patch('agents.triage.classifiers.v8.classifier_v8.AutoTokenizer')
    @patch('agents.triage.classifiers.v8.classifier_v8.Path.exists')
    ...
    @patch('agents.triage.classifiers.v8.classifier_v8.torch.cuda.is_available')
    @patch('agents.triage.classifiers.v8.classifier_v8.RobertaForSequenceClassification')
    @patch('agents.triage.classifiers.v8.classifier_v8.AutoTokenizer')
    @patch('agents.triage.classifiers.v8.classifier_v8.Path.exists')
    ...
    def test_global_classifier_function(self):
        with patch('agents.triage.classifiers.v8.classifier_v8._classifier.classify') as mock_classify:
    ...
    @patch('agents.triage.classifiers.v8.classifier_v8.PeftModel')
    @patch('agents.triage.classifiers.v8.classifier_v8.RobertaForSequenceClassification')
    @patch('agents.triage.classifiers.v8.classifier_v8.AutoTokenizer')
    @patch('agents.triage.classifiers.v8.classifier_v8.Path.exists')
