"""Tests for V0 classifier - Minimal DSPy prompt baseline."""
...
from agents.triage.classifiers.v0 import classifier_v0
...
@pytest.mark.asyncio
async def test_classifier_v0_evaluation():
    """Test v0 classifier accuracy meets minimum threshold."""
    ...
    classifier_version = "classifier_v0"
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        accuracy, results, all_scores, metrics = run_evaluation(
            classifier_v0, classifier_version, lm
        )
        ...
        assert accuracy > 0.6, (
            "Evaluation score is below threshold. Basic classifier v0 needs improvement."
        )
