...
class TestClassifierComparison:
    ...
    @patch('agents.triage.classifiers.v6.classifier_v6.dspy.configure')
    @patch('agents.triage.classifiers.v6.classifier_v6.classifier_v6')
    @patch('agents.triage.classifiers.v7.classifier_v7._classifier')
