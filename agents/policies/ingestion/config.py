...
class Settings(BaseSettings):
    ...
    vespa_artifacts_dir: Path | None = Field(default=None, description="Custom artifacts directory")
    vespa_hosts_config: Path | None = Field(default=None, description="Path to hosts configuration file")
    vespa_services_xml: Path | None = Field(default=None, description="Path to custom services.xml file")
